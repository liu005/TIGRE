...
# Linear source
def staticDetLinearSourceGeo(geo, s_pos, s_rot=0, rot=0, offDet=None) -> Geometry:
    """
    ...
    # offDet: overwrites detector offsets if not None. Size (2 x len(s_pos)).
    """
    ngeo = copy.deepcopy(geo)    
    ...
    if offDet is None:
        ...
        offDet0, offDet1 = offDet[:,0], offDet[:,1]
...
def ArbitrarySourceDetMoveGeo(geo, s_pos, d_pos=None, d_rot=None) -> Geometry:
    ...
    #   dedicated exact path. Use tilted_axis_geo (later in THIS module) for
...
# ===========================================================================
# TILTED ROTATION AXIS (merged from tilted_axis_geometry.py, 2026-09-02)
# ===========================================================================
